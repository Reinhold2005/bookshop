...
<div class="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600">
    <div class="max-w-7xl mx-auto px-4 py-20">
        <div class="text-center text-white">
            <h1 class="text-5xl font-bold mb-4">📚 Welcome to Bookshop</h1>
        ...
        <div class="mt-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-lg shadow p-4">
                    <h3 class="font-bold text-lg"><?php echo e($book->title); ?></h3>
                    <p class="text-gray-600">by <?php echo e($book->author); ?></p>
                    <p class="text-green-600 font-bold mt-2">$<?php echo e(number_format($book->price, 2)); ?></p>
                    <a href="<?php echo e(route('books.show', $book)); ?>" class="mt-3 inline-block bg-blue-500 text-white px-4 py-2 rounded text-center">
                        View Details
                    </a>
                </div>
...
<?php echo $__env->make('app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Test\bookshop\resources\views\dashboard.blade.php ENDPATH**/ ?>