...
<div id="cartSidebar" class="fixed right-0 top-0 h-full w-96 bg-white shadow-2xl transform translate-x-full transition-transform duration-300 z-50">
    <div class="flex flex-col h-full">
        ...
        <div class="border-t p-4 bg-gray-50" id="cartFooter" style="display: none;">
            ...
            <a href="<?php echo e(route('cart.index')); ?>" class="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition text-center block mb-2">
                View Cart
            </a>
            <a href="<?php echo e(route('checkout.index')); ?>" class="w-full bg-green-500 text-white py-2 rounded-lg hover:bg-green-600 transition text-center block">
                Proceed to Checkout
            </a>
        </div>
    </div>
...
<?php /**PATH C:\Test\bookshop\resources\views\components\cart-sidebar.blade.php ENDPATH**/ ?>