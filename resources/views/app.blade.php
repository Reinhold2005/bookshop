...
<head>
    ...
    <title>Tales & Tomes Bookshop- @yield('title', 'Your Online Bookstore')</title>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-4">
                    <!-- Home Button -->
                    <a href="{{ url('/') }}" class="home-button bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition">
                    ...
                    <a href="{{ route('client.orders.index') }}" class="text-white font-semibold hover:text-blue-500">My Orders</a>
                </div>
                <div class="flex items-center space-x-12">
                    <a href="{{ route('books.index') }}" class="text-white hover:text-blue-500 text-lg font-semibold">Books</a>
                    <a href="{{ route('cart.index') }}" class="text-white hover:text-blue-500 test-lg font-semibold">🛒 Cart</a>
                    <a href="{{ route('wishlist.index') }}" class="text-white hover:text-blue-500 text-lg font-semibold">Wishlist</a>
                    @auth
...
<footer class="bg-gray-900 text-white mt-8">
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li><a href="{{ route('wishlist.index') }}" class="hover:text-white transition">My Wishlist</a></li>
                    <li><a href="{{ route('client.orders.index') }}" class="hover:text-white transition">My Orders</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm">
            <p>&copy; {{ date('Y') }} Tales & Tomes Bookshop. All rights reserved. | Designed with <i class="fas fa-heart text-red-500"></i> for book lovers</p>
        </div>
    </div>
</footer>
</body>
