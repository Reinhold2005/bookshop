        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition">
                    ...
                    <!-- View Site Button -->
                    <a href="{{ url('/') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition flex items-center gap-1" target="_blank">
                        <i class="fas fa-external-link-alt"></i> View Site
                    </a>
                </div>
<a href="{{ route('admin.reports.sales') }}" class="text-white hover:text-purple-300 text-lg font-semibold">
    Sales Reports
</a>
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <a href="{{ route('admin.books.index') }}" class="text-white hover:text-purple-300 text-lg font-semibold">
                        Manage Books
                    </a>
                    
                    <a href="{{ route('admin.orders.index') }}" class="text-white hover:text-purple-300 text-lg font-semibold">
                        Manage Orders
                    </a>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
            <div class="flex items-center gap-4 mb-2 md:mb-0">
                ...
                <p>&copy; {{ date('Y') }} Tales & Tomes Bookshop Admin Panel. All rights reserved.</p>
            </div>
