...
@section('content')
@include('admin.components.low-stock-alert')
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.books.index') }}" class="text-blue-500 text-sm hover:underline">Manage Books →</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.orders.index') }}" class="text-green-500 text-sm hover:underline">Manage Orders →</a>
            </div>
        </div>
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="px-6 py-3 bg-gray-50 border-t">
                    <a href="{{ route('admin.orders.index') }}" class="text-blue-500 hover:underline text-sm">View All Orders →</a>
                </div>
            </div>
        </div>
